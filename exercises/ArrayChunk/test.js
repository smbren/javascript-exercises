...
describe('Chunk function', () => {
  ...
  test('should correctly divide an array of 3 elements with chunk size 1', () => {
    const arr = [1, 2, 3];
  ...
  test('should correctly divide an array of 5 elements with chunk size 3', () => {
    const arr = [1, 2, 3, 4, 5];
  ...
  test('should correctly divide an array of 13 elements with chunk size 5', () => {
